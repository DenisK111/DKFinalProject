...
namespace Metflix.Host.Validators
{
    public static class ValidationMessages
    {
        ...
        public static string InvalidDateTimeFormat { get;} = $"Date should be in one of the following formats: {Environment.NewLine}{string.Join(Environment.NewLine,DateTimeFormats.AcceptableInputFormats)}";
    }
}
